...
$this->append('css', $this->Html->css(["jquery-ui.css"]));
$this->append('script', $this->Html->script(["jquery-3.4.1.js"]));
$this->append('script', $this->Html->script(["jquery-ui.js"]));
$this->append('script', $this->Html->script(["datepicker-ja.js"]));
$this->append('script', $this->Html->script(["pullDown"]));
